          ...
          <div class="container-fluid">
            ...
            <div class="card mb-4">
              <div class="card-body">
                ...
                <input type="checkbox" />주택 전월세 &nbsp; &nbsp;<input
                  type="text"
                />
                &nbsp; &nbsp;<button>검색</button>
              </div>
            ...
            <script
              defer
              src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBg7Lrvs5AWd6tuOOgY4vEWjoK2vVGM3V0&callback=initMap"
            ></script>
